    ...
    private ToolBar createToolBar(Composite parent) {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                for (int i = 0; i < aaa.length; i++) {
                    System.out.println(aaa[i]
                            + FontStyle.valueOf("BOLD").name());
                }
                try {
                    setFormattedText("<p>a<b>a</b><b><i>a</i></b><cc1 col=\"100\">bb<cc1 col=\"100\">bb</cc1>bb</cc1>b</p>");
        ...
        tltmNewItem_2.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                // FontData fdarray[] =
                // JFaceResources.getDialogFontDescriptor().createFrom("arial",
                // 20, 0).getFontData();
                styleRange.font = new Font(null, fd);

                styleRange.foreground = new Color(getDisplay(), fontdialog
                        .getRGB());
