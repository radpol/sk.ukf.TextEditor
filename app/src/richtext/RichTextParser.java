...
public final class RichTextParser {
    ...
    private final List<StyleRange> styleRangeList = new ArrayList<StyleRange>();
    ...
    private class RichTextContentHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String qName)
            ...
            boolean recognized = ("p".equals(qName) || "b".equals(qName)
                    || "i".equals(qName) || "ins".equals(qName)
                    || "del".equals(qName) || "cc1".equals(qName));
            if (!recognized) {
                return;
            }
            ...
            for (FontStyle fs : styles) {
                if (fs != null) {
                    ...
                    case STRIKE_THROUGH:
                        ...
                        break;
                    case CUSTOM_COLOR_1:
                        range.foreground = JFaceResources.getColorRegistry()
                                .get(fs.name());
                        break;
                    case CUSTOM_COLOR_2:
                        break;
